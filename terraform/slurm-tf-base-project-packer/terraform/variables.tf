...
variable "ig_name" {
  description = "(Optional) - Name of the instance group."
  type        = string
  default     = null
}

variable "ig_image_name" {
  description = "(Optional) - The image to use for the instances."
  type        = string
  default     = "nginx"
}

variable "ig_image_tag" {
  description = "(Optional) - The image tag to use for the instances."
  type        = string
  default     = "1"
}
